...
public class GT4500 implements SpaceShip {
  ...
  public boolean wasPrimaryFiredLast(){
    return this.wasPrimaryFiredLast;
  }
  ...
  */
  ...
  public boolean fireTorpedo(FiringMode firingMode) {
    ...
    switch (firingMode) {
      ...
      case ALL:
        // try to fire both of the torpedo stores checking if there is are any torpedos in the stores

        //initially no torpedos
        if(secondaryTorpedoStore.isEmpty() && primaryTorpedoStore.isEmpty()){
          firingSuccess = false;
          break;
        }

        //firing secondaries till the store is empty
        ...
        //firing primaries till the store is empty
        ...
        //for now both stores should be empty
        if(secondaryTorpedoStore.isEmpty() && primaryTorpedoStore.isEmpty()){
          firingSuccess = true;
        }
        break;
